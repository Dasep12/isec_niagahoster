...
class Patrol extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("SPV/patrol/patrol", $data);
    ...
    public function showPatroli()
    {
        ...
        $this->load->view("SPV/patrol/reporting_patrol", $data);
    ...
    public function tarikExcel()
    {
        ...
        $this->load->view("SPV/patrol/excel_patroli", $data);
    }
    ...
    public function reportPeriodik()
    {
        ...
        $data = $this->load->view('SPV/patrol/pdf_patroli', $data,  TRUE);
        $mpdf->WriteHTML($data);
