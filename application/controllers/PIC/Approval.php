...
class Approval extends CI_Controller
{
    ...
    public function overtime()
    {
        ...
        $data = [
            ...
            from pengajuan_lembur p , biodata b  , employee e where p.npk = b.npk and p.wilayah='" . $wil . "' and p.status_lembur ='0' and e.id_employee = b.id_biodata and (e.jabatan = 'KORLAP' or e.jabatan = 'ANGGOTA' or e.jabatan = 'PKD'  or e.jabatan = 'DANRU')"),
            'link'  => $this->uri->segment(2),
        ];
        $this->load->view("web/pic/header", $data);
        $this->load->view("PIC/approval/overtime", $data);
    ...
    public function approve_ot()
    {
        ...
        if ($dataLembur->num_rows() > 0) {
            ...
            if ($update) {
                ...
                redirect('PIC/Approval/overtime');
            } else {
    ...
    public function skta()
    {
        ...
        $data = [
            ...
            from pengajuan_skta p , biodata b  , employee e where p.npk = b.npk and p.wil='" . $wil . "' and p.status='0' and e.id_employee = b.id_biodata and (e.jabatan = 'KORLAP' or e.jabatan = 'ANGGOTA' or e.jabatan = 'PKD' or e.jabatan = 'DANRU' ) "),
            'link'  => $this->uri->segment(2),
        ];
        $this->load->view("web/pic/header", $data);
        $this->load->view("PIC/approval/skta", $data);
        $this->load->view("web/pic/fotter");
    }
    ...
    public function cuti()
    {
        ...
        $wil  =  $wl->wilayah;
        $data = [
            'data'  =>  $this->db->query("select c.id , c.nama , c.npk ,  c.tanggal_cuti , c.alasan_cuti  from pengajuan_cuti c , biodata b  , employee e  where  c.wilayah='" . $wil . "' and c.status = 0  and b.npk = c.npk and b.id_biodata = e.id_employee and (e.jabatan = 'KORLAP' or e.jabatan = 'ANGGOTA' or e.jabatan = 'PKD' or e.jabatan = 'DANRU' ) "),
            'link'  => $this->uri->segment(2),
        ];

        $this->load->view("web/pic/header", $data);
        $this->load->view("PIC/approval/cuti", $data);
        $this->load->view("web/pic/fotter");
    }
    ...
    public function sakit()
    {
        ...
        $data = [
            ...
            WHERE pp.npk = b.npk AND b.id_biodata = e.id_employee AND pp.status = 0 AND pp.wilayah = '" . $wil . "' and (e.jabatan = 'KORLAP' or e.jabatan = 'ANGGOTA' or e.jabatan = 'PKD' or e.jabatan = 'DANRU' ) "),
            'link'  => $this->uri->segment(2),
        ];

        $this->load->view("web/pic/header", $data);
        $this->load->view("PIC/approval/sakit", $data);
        $this->load->view("web/pic/fotter");
    }
