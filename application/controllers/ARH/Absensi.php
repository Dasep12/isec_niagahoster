...
class Absensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("web/arh/header", $data);
        $this->load->view("ARH/form_unduh_absen", $data);
        $this->load->view("web/arh/fotter");
    }
    ...
    public function download(Type $var = null)
    {
        ...
        WHERE b.id_biodata = e.id_employee AND e.wilayah = '" . $wilayah . "' and 
        (e.jabatan LIKE '%ANGGOTA%' OR e.`jabatan` LIKE '%KORLAP%'  ) 
        AND e.status = 1 AND b.status = 1  ORDER BY area_kerja ASC ");
