...
class Patrol extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("SA/patrol/patrol", $data);
    ...
    public function showPatroli()
    {
        ...
        $this->load->view("SA/patrol/reporting_patrol", $data);
    ...
    public function tarikExcel()
    {
        ...
        $this->load->view("SA/patrol/excel_patroli", $data);
    }
    ...
    public function reportPeriodik()
    {
        ...
        $data = $this->load->view('SA/patrol/pdf_patroli', $data,  TRUE);
        $mpdf->WriteHTML($data);
