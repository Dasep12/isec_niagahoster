...
class Patrolv2 extends CI_Controller
{
    function __construct()
    {
        ...
        $stat = $this->session->userdata('status_patrol');
        $this->load->model('PatrolModel', 'model');
    ...
    public function index()
    {
        ...
        $this->load->view("Ipatrol/scan_barcode", $data);
    ...
    public function getIDPLAN()
    {
        ...
        $this->load->view("Ipatrol/pilih_titik", $data);
    }
    ...
    public function input_report($id)
    {
        ...
        $this->load->view('mobile/header', $data);
        $this->load->view("Ipatrol/Input_report", $data);
        $this->load->view('mobile/fotter');
    }
