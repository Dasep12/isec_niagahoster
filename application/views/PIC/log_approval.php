                        ...
                        <tbody>
                            ...
                            foreach ($overtime->result() as $ot) : ?>
                                <tr>
                                    ...
                                    <td><?= $ot->status_lembur == 1 ? '<span class="badge badge-success">Approve</span>' : '<span class="badge badge-danger">Rejected</span>' ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            foreach ($cuti->result() as $ct) : ?>
                                <tr>
                                    ...
                                    <td><?= $ct->status == 1 ? '<span class="badge badge-success">Approve</span>' : '<span class="badge badge-danger">Rejected</span>' ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            foreach ($skta->result() as $st) : ?>
                                <tr>
                                    ...
                                    <td><?= $st->keterangan ?></td>
                                    <td><?= $st->status == 1 ? '<span class="badge badge-success">Approve</span>' : '<span class="badge badge-danger">Rejected</span>' ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            foreach ($sakit->result() as $sk) : ?>
                                <tr>
                                    ...
                                    <td><?= $sk->keterangan ?></td>
                                    <td><?= $sk->status == 1 ? '<span class="badge badge-success">Approve</span>' : '<span class="badge badge-danger">Rejected</span>' ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
