                        ...
                        if ($data->num_rows() > 0) {
                            foreach ($data->result() as $dt) : ?>
                                <tr>
                                    ...
                                    <td><?= $dt->keterangan ?></td>
                                    <td>
                                        <a onclick="return confirm('Approve Overtime ?')" title="Approve Overtime" href="<?= base_url('PIC/Approval/approve_ot?id=' . $dt->id) ?>" class="btn btn-sm btn-success"><i class="fas fa-check"></i></a>
                                        <a onclick="return confirm('Tolak Overtime ?')" title="Tolak Overtime" href="<?= base_url('PIC/Approval/reject_ot?id=' . $dt->id) ?>" class="btn btn-sm btn-danger">
