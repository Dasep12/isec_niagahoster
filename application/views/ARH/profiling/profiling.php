<div class="container  mt-4">
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <a href="<?= base_url('ARH/Profiling/unduh') ?>" class=" mb-2 btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Download</a>
...
<script>
    $("#edit-data").on("show.bs.modal", function(event) {
        ...
        $.ajax({
            url: "<?= base_url('ARH/Profiling/modalBiodata') ?>",
            method: "POST",
            data: 'npk=' + npk,
            success: function(e) {
                console.log(npk)
    ...
    $("#report_absen").on('submit', function(e) {
        ...
        $.ajax({
            url: "<?= base_url('ARH/Profiling/modalAbsensi') ?>",
            method: "POST",
