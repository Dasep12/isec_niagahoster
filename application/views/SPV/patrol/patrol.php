                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <form method="post" target="_blank" action="<?= base_url('SPV/Patrol/tarikExcel') ?>">
                                <label for="">Pilih Area Kerja</label>
                                <select name="area_patrol" id="" class="form-control text-dark mb-2">

                                    <?php
                                    if ($this->session->userdata('npk') == 22325) { ?>
                                    ...
                                    <?php } else if ($this->session->userdata('npk') == 46785) { ?>
                        ...
                        <div class="col-lg-6 mb-2">
                            <form method="post" target="_blank" action="<?= base_url('SPV/Patrol/reportPeriodik') ?>">
                                <label for="">Pilih Area Kerja</label>
