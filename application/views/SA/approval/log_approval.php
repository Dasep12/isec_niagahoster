        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <table id="table_id" class="table-sm small table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                ...
                <div class="tab-pane fade" id="cuti" role="tabpanel" aria-labelledby="cuti-tab">
                    <table id="table_id4" class="table-sm small table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead class="bg-dark text-white">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                ...
                <div class="tab-pane fade" id="skta" role="tabpanel" aria-labelledby="skta-tab">
                    <table id="table_id2" class="table-sm small table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead class="bg-dark text-white">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                ...
                <div class="tab-pane fade" id="sakit" role="tabpanel" aria-labelledby="sakit-tab">
                    <table id="table_id3" class="table-sm small table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead class="bg-dark text-white">
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
